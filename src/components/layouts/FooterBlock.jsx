...
export default function FooterBlock({ isFull }) {
  ...
  return (
    <>
          ...
          <Container>
            ...
            >
              ...
              >
                ...
                >
                  <Grid item xs={12}>
                    <Typography variant="subtitle1" sx={{ color: "#1e1e1e" }}>
                      WISE QMS
                    </Typography>
                  </Grid>
                  <Grid item xs={12}>
                    ...
                    >
                      <Typography
                        variant="h2"
                        sx={{ color: "#1e1e1e", fontWeight: 700 }}
                      >
      ...
      <Box
        sx={{ pt: isFull ? 0 : { md: 10, xs: 8 }, pb: 10, bgcolor: "#808285" }}
      >
        <Container>
          <Grid
            container
              ...
              >
                <Grid container spacing={{ md: 5, xs: 2 }} sx={{ pt: 0 }}>
                  ...
                  <Grid item xs={12}>
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: 400, color: "#1e1e1e" }}
                    >
                    ...
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: 400, color: "#1e1e1e", mt: 2 }}
                    >
      ...
      <Divider sx={{ borderColor: "#808285" }} />
      <Box sx={{ py: 1.5, bgcolor: "#808285" }}>
        <Container>
