          ...
          <Grid container spacing={2} sx={{ pr: 0, [theme.breakpoints.down('md')]: { textAlign: 'center' } }}>
            ...
            <Grid item xs={12} md={8} lg={12}>
              ...
              >
                ...
                >
                  Moderno sistema de gestión de calidad enfocado en operaciones de pequeño y mediano porte que buscan crecer de manera ágil
                  y organizada. Diseñado para adaptarse a las necesidades de mercados emergentes en América Latina.
                </Typography>
              </motion.div>
            </Grid>
          </Grid>
